...
import itemDatas from "../../../assets/json/sneakerbrands.json";
import NikeBrandImage from "../../../assets/brandimgs/nike.webp";
import AdidasBrandImage from "../../../assets/brandimgs/adidas.webp";
import NewBalanceBrandImage from "../../../assets/brandimgs/newbalance.webp";
import AirJordanBrandImage from "../../../assets/brandimgs/airjordan.webp";
import SalomonBrandImage from "../../../assets/brandimgs/salomon.webp";
import AsicsBrandImage from "../../../assets/brandimgs/asics.webp";
import YeezyBrandImage from "../../../assets/brandimgs/yeezy.webp";

const images = {
  NikeBrandImage,
    AdidasBrandImage,
    NewBalanceBrandImage,
    AirJordanBrandImage,
    SalomonBrandImage,
    AsicsBrandImage,
    YeezyBrandImage
    ...
    return (
        <div className="w-full h-max px-20 phone:px-4 flex flex-col gap-6 mt-20">
            <div className="w-full h-max flex justify-between">
                <p className="text-3xl font-medium">Our sneaker brands</p>
                    ...
                    {itemDatas.map((item, index) => (
                        ...
                        >
                            <div className="w-full h-96 phone:h-72 relative bg-[#f5f5f5] flex items-center">
                                <img src={images[item.brandimg]} alt={item.name} className="w-full h-full object-cover" />
                            </div>
...
export default HomeSneakerBrands;
